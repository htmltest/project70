;(function ( $, window, document, undefined ) {
	...
	Plugin.prototype = {
		...
		addEventListeners: function(){
			this.$element.on('mousemove', this.onTap.bind(this));
			this.$element.on('touchstart', this.options.dragElementSelector, this.onDragStart.bind(this));
			this.$element.on('touchmove', this.onDrag.bind(this));

			this.$element.on('mouseout', this.onDragEnd.bind(this));
		...
		setDimensions: function(){
			...
			this.minLeftPos = this.containerOffset;
			this.maxLeftPos = this.containerOffset + this.containerWidth;
			this.isDragging = false;
		}
