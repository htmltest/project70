;(function ( $, window, document, undefined ) {
	...
	Plugin.prototype = {
		...
		addEventListeners: function(){
			this.$element.on('click mousemove', this.onTap.bind(this));
			this.$element.on('mousemove mousedown touchstart', this.options.dragElementSelector, this.onDragStart.bind(this));
